...
import com.arquitecturajava.repositories.mappers.ChapterMapper;
...
public class ChapterRepositoryJDBC implements ChapterRepository {
    ...
    public int insert(Chapter chapter) {
        ...
        return this.template.update(QUERY, chapter.getPk_title(), chapter.getPages(), chapter.getPk_fk_book().getPk_isbn());
    }
    ...
    public int delete(Chapter chapter) {
        ...
        return this.template.update(QUERY, chapter.getPk_title(), chapter.getPk_fk_book().getPk_isbn());
    }
