...
import com.arquitecturajava.repositories.mappers.BookMapper;
import com.arquitecturajava.repositories.mappers.BookWithChaptersMapper;
import com.arquitecturajava.repositories.mappers.BooksWithChaptersMapper;
...
public class BookRepositoryJDBC implements BookRepository {
    ...
    public int insert(Book book) {
        ...
        return this.template.update(QUERY, book.getPk_isbn(), book.getTitle(), book.getFk_author().getPk_id());
    }
    ...
    public int update(Book book) {
        ...
        return this.template.update(QUERY, book.getTitle(), book.getFk_author().getPk_id(), book.getPk_isbn());
    }
